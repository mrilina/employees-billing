...
/**
 * Класс для обработки исключений всех контроллеров.
 *
 * @author Irina Ilina
 */
...
public class ControllerExceptionHandler {
  ...
  /**
   * Обработка исключительной ситуации "Ресурс не найден".
   *
   * @param ex исключение
  ...
  /**
   * Обработка исключительной ситуации "Некорректные параметры запроса".
   *
   * @param ex исключение
   * @param request запрос
   * @return сообщение
